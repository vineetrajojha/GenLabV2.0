        ...
        <div class="card">
            ...
            <div class="mb-4 mt-4 ms-3">
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('superadmin.bookingInvoiceStatuses.index', [
                    ...
                    @foreach($departments as $dept)
                        <a href="{{ route('superadmin.bookingInvoiceStatuses.index', ['department' => $dept->id, 'search' => request('search'), 'payment_option' => request('payment_option', 'without_bill')]) }}"
            ...
            <div class="card-body p-0">
                <form action="{{ route('superadmin.cashLetter.payments.showMultiple') }}" method="GET">
                    @csrf
                <div class="table-responsive">
                    <table class="table table-hover"> <!-- Added table-hover -->
                        ...
                        <tbody>
                            ...
                            <tr   @if($isPaid) class="table-success" @endif>
                                <td>
                                    <label class="checkboxs">
