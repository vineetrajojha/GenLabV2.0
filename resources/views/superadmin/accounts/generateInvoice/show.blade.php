        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered mb-4">
                    <tr>
                        <th>Client Name</th>
                        <td class="noteditable" id="td_client_name">{{ $booking->client_name }}</td>
                        <th>Marketing Person</th>
                        <td class="noteditable" id="td_marketing_person">{{ $booking->marketingPerson->name ?? '-' }}</td>
                    </tr>
                    <tr>
                        <th>Invoice No </th>
                        <td class="noteditable" id="td_invoice_no">{{$booking->invoice_no}}</td>
                        <th>Reference No</th>
                        <td class="noteditable" id="td_reference_no">{{ $booking->reference_no }}</td>
                    </tr>
                    <tr>
                        <th>Invoice Date</th>
                        <td class="noteditable" id="td_invoice_date">{{ date('d-m-Y') }}</td>
                        <th>Letter Date</th>
                        <td class="noteditable" id="td_letter_date">{{ \Carbon\Carbon::parse($booking->job_order_date)->format('d-m-Y') }}</td>
                    </tr>
                    <tr>
                        <th>Name of Work</th>
                    ...
                    <tr>
                        ...
                        <th>SAC CODE</th>
                        <td contenteditable="true" class="editable" id="td_sac_code"></td>
                    </tr>
                </table>
