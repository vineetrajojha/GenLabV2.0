    ...
    <div class="content">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
            <div>
                ...
                <p class="text-muted mb-0">{{ $insightMessage }}</p>
            </div>
        </div>
                ...
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column gap-2">
                            <a href="{{ route('superadmin.dashboard.index') }}" class="btn btn-outline-primary d-flex align-items-center gap-2">
                                <i class="ti ti-layout-grid"></i>
                                <span>Return to Main Dashboard</span>
                            </a>
                            <a href="{{ route('superadmin.departments.index') }}" class="btn btn-outline-secondary d-flex align-items-center gap-2">
