    ...
    <div class="content">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
            <div>
                ...
                <p class="text-muted mb-0">Snapshot tailored for {{ $user->name ?? 'you' }}.</p>
            </div>
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('superadmin.marketing.expenses.view') }}" class="btn btn-primary d-flex align-items-center gap-2">
                    <i class="ti ti-cash"></i>
                    <span>Submit Expense</span>
                </a>
                <a href="{{ route('superadmin.bookings.newbooking') }}" class="btn btn-outline-secondary d-flex align-items-center gap-2">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="d-flex align-items-center justify-content-between border-bottom py-2">
                                ...
                                <span class="badge bg-warning text-dark">{{ $metricLookup->get('Pending Expenses', 0) }}</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between border-bottom py-2">
                                <span>Campaign spend this month (₹)</span>
                                <span class="badge bg-info text-dark">{{ $metricLookup->get('Spend This Month (₹)', 0) }}</span>
                            </li>
                            <li class="d-flex align-items-center justify-content-between pt-2">
                                <span>Bookings in pipeline</span>
                                <span class="badge bg-primary">{{ $metricLookup->get('Active Bookings', 0) }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
