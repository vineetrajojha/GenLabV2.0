...
<div class="card mt-4">
    ...
    <div class="card-body">
        <form id="paymentForm" action="{{ route('superadmin.cashPayments.storeRepay', $payment_info->invoice_id) }}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control fw-bold" value="{{ $payment_info->client }}" readonly>
                </div> 
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-bold">Marketing Person</label>
                    <input type="text" class="form-control fw-bold" value="{{ $payment_info->marketing_person }}" readonly>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-bold">Letter No</label>
                    <input type="text" class="form-control fw-bold" value="{{ $payment_info->letter_no }}" readonly>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control fw-bold" value="{{ $payment_info->invoice_no }}" readonly>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-bold">Invoice Date</label>
                    <input type="date" class="form-control fw-bold" value="{{ $payment_info->invoice_date }}" readonly>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label fw-bold">Total Invoice Amount</label>
                    <input type="number" id="total_amount" class="form-control fw-bold" value="{{ $payment_info->total_invoice_amount }}" readonly>
                </div>
            </div>

            {{-- Row 3 --}}
            <div class="row"> 
                <div class="col-md-2 mb-3"> <label class="form-label fw-bold">TDS (%)</label> <input type="number" id="tds_percentage" class="form-control fw-bold" value="{{ $payment_info->tds_percentage }}" step="0.01" readonly> </div>
                <div class="col-md-2 mb-3">
                    <label class="form-label fw-bold">Amount After TDS</label>
                    <input type="number" id="amount_after_tds" class="form-control fw-bold" value="{{ $payment_info->payable_amount_after_tds }}" readonly>
                </div> 
                <div class="col-md-2 mb-3">
                    <label class="form-label fw-bold">Paid Amount</label>
                    <input type="number" id="paid_amount" class="form-control fw-bold" value="{{ $payment_info->total_paid_amount }}" readonly>
                </div>
                <div class="col-md-2 mb-3">
                    <label class="form-label fw-bold">Due Amount</label>
                    <input type="number" id="due_amount" class="form-control fw-bold" value="{{ $payment_info->total_due_amount }}" readonly>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" id="amount_received" name="amount_received" class="form-control fw-bold" value="{{ $payment_info->total_due_amount }}" step="0.01" required>
                </div>
                <div class="col-md-4 mb-3">
