    ...
    <table class="MsoTableGrid" border="1" cellspacing="0" cellpadding="0" width="718" style="width: 72.3169%; margin-left: -2.18487%; margin-bottom:20px;">
        <tbody>
            ...
            <tr style="height: 7px;">
                ...
                <td width="85" style="width: 85px; padding: 0px 7px; height: 7px; text-align: center;">{{ $date_of_receipt }}</td>
            </tr>
            ...
            <tr style="height: 5px;">
                ...
                <td width="85" style="width: 85px; padding: 0px 7px; height: 5px; text-align: center;">{{ $date_of_start_analysis }}</td>
            </tr>
            ...
            <tr style="height: 12px;">
                ...
                <td width="283" valign="top" style="width: 282px; padding: 0px 7px; height: 12px;">{!! nl2br(e($letter_ref)) !!}</td>
                ...
                <td width="85" style="width: 85px; padding: 0px 7px; height: 12px; text-align: center;">{{ $date_of_completion }}</td>
            </tr>
            ...
            <tr style="height: 5px;">
                ...
                <td width="283" style="width: 282px; padding: 0px 7px; height: 5px;">{!! nl2br(e($sample_description)) !!}</td>
                <td width="151" style="width: 150px; padding: 0px 7px; height: 5px;">Date of Issue</td>
                <td width="19" style="width: 19px; padding: 0px 7px; height: 5px;">:</td>
                <td width="85" style="width: 85px; padding: 0px 7px; height: 5px; text-align: center;">{{ $date_of_issue }}</td>
            </tr>

            <tr style="height: 5px;">
                <td width="160" style="width: 160px; padding: 0px 7px; height: 5px;">Name of Work</td>
                <td width="19" valign="top" style="width: 19px; padding: 0px 7px; height: 5px;">:</td>
                <td width="539" colspan="4" style="width: 536px; padding: 0px 7px; height: 5px;">{!! nl2br(e($name_of_work)) !!}</td>
            </tr>
        </tbody>
    </table>
</div>
