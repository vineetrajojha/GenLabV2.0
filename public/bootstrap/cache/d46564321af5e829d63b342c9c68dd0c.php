...
<div class="card mt-3">
    ...
    <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
        ...
        <div class="search-set">
            <form method="GET" action="<?php echo e(route('superadmin.office.expenses.view')); ?>" class="d-flex input-group">
            ...
            <table class="table table-hover align-middle mb-0" id="expensesTable">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('superadmin.marketing.expenses._row', ['expense' => $expense, 'serial' => $expenses->firstItem() + $index, 'isApprovalPage' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        document.getElementById('btnExportOfficePdf')?.addEventListener('click', (e) => {
            ...
            window.location.href = `<?php echo e(route('superadmin.office.expenses.export.pdf')); ?>` + '?' + params.toString();
        });

        document.getElementById('btnExportOfficeExcel')?.addEventListener('click', (e) => {
            e.preventDefault();
            const params = buildOfficeQuery();
            window.location.href = `<?php echo e(route('superadmin.office.expenses.export.excel')); ?>` + '?' + params.toString();
        });
...
<?php echo $__env->make('superadmin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Mamp\htdocs\GenLabV1.0\resources\views/superadmin/office/expenses/index.blade.php ENDPATH**/ ?>