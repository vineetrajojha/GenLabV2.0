<?php $__env->startSection('title', 'Cheque Print Preview'); ?>
...
<div class="content container-fluid">
  <div class="page-header d-flex justify-content-between align-items-center">
    ...
    <div class="no-print d-flex align-items-center gap-2">
      ...
      <?php if($bank): ?>
        <a href="<?php echo e(route('superadmin.cheque-templates.editor', ['bank' => $bank->id, 'cheque' => $cheque->id, 'return' => request()->fullUrl()])); ?>" target="_blank" rel="noopener" class="btn btn-warning me-1">
    ...
    <div class="card-body">
      <div class="preview-wrapper">
        <div class="cheque-preview print-area" id="chequePreview">
          <?php if($bank && $bank->cheque_image_path): ?>
            <img src="<?php echo e(asset('storage/'.$bank->cheque_image_path)); ?>" alt="Cheque" id="chequeBg">
          <?php else: ?>
          ...
          <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="overlay-field"
                 ...
                 data-font-size="<?php echo e($fs); ?>"
                 <?php echo e($ls !== null ? 'data-letter-spacing='.$ls : ''); ?>>
                 <?php echo e($value); ?>
          ...
          <?php if($hasDateBoxes): ?>
            <?php $digits = optional($cheque->date)->format('dmY'); ?>
            <?php for($i=1;$i<=8;$i++): ?>
              <?php
        ...
        <div class="info-panel no-print">
          <div class="card">
            ...
            <div class="card-body">
              <div><strong>Bank:</strong> <?php echo e($cheque->bank ?: '—'); ?></div>
              <div><strong>Cheque No:</strong> <?php echo e($cheque->cheque_no); ?></div>
              <div><strong>Payee:</strong> <?php echo e($cheque->payee_name); ?></div>
              <div><strong>Date:</strong> <?php echo e(optional($cheque->date)->format('d M Y') ?: '—'); ?></div>
              <div><strong>Amount:</strong> <?php echo e(number_format($cheque->amount,2)); ?></div>
              <div><strong>In words:</strong> <?php echo e($cheque->amount_in_words); ?></div>
              <?php if(!$bank): ?>
                <div class="alert alert-warning mt-3">No template found for bank "<?php echo e($cheque->bank); ?>". Set it under Accounts → Cheque Template.</div>
              <?php endif; ?>
            </div>
          </div>
        </div>
...
(function(){
  ...
  const bankKey = <?php echo json_encode(optional($bank)->id ?? ('bank:' . ($cheque->bank ?? 'unknown')), 15, 512) ?>;
...
<?php echo $__env->make('superadmin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\GenTech\htdocs\GenTech_bug\bankTransaction\GenLab\resources\views/superadmin/accounts/cheques/print-preview.blade.php ENDPATH**/ ?>