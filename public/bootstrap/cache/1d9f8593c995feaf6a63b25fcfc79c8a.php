...
<div class="row"> 
        ...
        <div class="a4-page"> 
            ...
            <form id="previewInvoiceForm"
                method="POST"
                action="<?php echo e(route('superadmin.bookingInvoiceStatuses.generateInvoice', $booking->id)); ?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-wide text-start text-uppercase" colspan="2" contenteditable="true">
                                    <?php echo e($booking->name_of_work ?? ''); ?><br>
                                    <br>
                    ...
                    <table class="bank-table">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2"><?php echo e($bankInfo->instructions ?? 'ABCSVHGVGHVSVGHSVD'); ?></td>
                            </tr>
                            <tr>
                                <th class="text-start">BANK NAME:</th>
                                <td><?php echo e($bankInfo->name ?? 'SBI'); ?></td>
    ...
    .addEventListener('submit', function () {
        ...
        let invoiceData = {
            ...
            booking_info: {
                ...
                reference_no: "<?php echo e($booking->reference_no ?? ''); ?>",
                invoice_date: "<?php echo e(date('d-m-Y')); ?>",
                letter_date: "<?php echo e($booking->job_order_date
                ...
                bill_issue_to: document.querySelector('[contenteditable][data-bill-issue]')?.innerText
                            || "",
                client_gstin: "<?php echo e($booking->gstin ?? ''); ?>",
                address: ""
            },
