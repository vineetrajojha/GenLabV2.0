        ...
        <div class="d-flex align-items-center flex-shrink-0" style="gap:10px; margin-left:18px;">
            ...
            <div class="dropdown ms-2">
                <a href="#" class="d-flex align-items-center" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo e($avatarUrl); ?>" alt="User" class="img-fluid" style="height:30px; width:30px; object-fit:cover; border-radius:6px;">
                </a>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                    ...
                    <li class="px-3 py-2">
                        <div class="d-flex align-items-center">
                            <img src="<?php echo e($avatarUrl); ?>" alt="User" class="rounded-circle me-2" style="height:32px; width:32px;">
                            <div>
...
<?php /**PATH C:\Mamp\htdocs\GenLabV2.0\resources\views/superadmin/layouts/include/header.blade.php ENDPATH**/ ?>