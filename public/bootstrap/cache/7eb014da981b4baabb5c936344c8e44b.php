				...
				<div class="content">
					<div class="page-header">
						...
						<ul class="table-top-head">
							<li class="me-2">
								<a id="leave-export-pdf" data-base-url="<?php echo e(route('superadmin.leave.export.pdf')); ?>" href="<?php echo e(route('superadmin.leave.export.pdf')); ?>" target="_blank" rel="noopener" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf">
									<img src="<?php echo e(asset('assets/img/icons/pdf.svg')); ?>" alt="PDF export">
								</a>
							</li>
							<li class="me-2">
								<a id="leave-export-excel" data-base-url="<?php echo e(route('superadmin.leave.export.excel')); ?>" href="<?php echo e(route('superadmin.leave.export.excel')); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Excel">
									<img src="<?php echo e(asset('assets/img/icons/excel.svg')); ?>" alt="Excel export">
								</a>
							</li>
							<li class="me-2">
							...
							<div class="d-flex table-dropdown my-xl-auto right-content align-items-center flex-wrap row-gap-3">
								<div class="me-2 date-select-small">
									<div class="input-addon-left position-relative">
										<input type="text" class="form-control datetimepicker" placeholder="Select Date" id="leave-filter-date" value="<?php echo e(request('date')); ?>">
										<span class="cus-icon"><i data-feather="calendar" class="feather-clock"></i></span>
									</div>
								</div>
								<div class="dropdown">
									<input type="hidden" id="leave-status-filter" value="<?php echo e(request('status', '')); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	const approveTemplate = <?php echo json_encode(route('superadmin.leave.approve', ['leave' => '__leave__']), 512) ?>;
	const deleteTemplate = <?php echo json_encode(route('superadmin.leave.destroy', ['leave' => '__leave__']), 512) ?>;
