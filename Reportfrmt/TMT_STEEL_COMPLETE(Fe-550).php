...
<table style=" width: 110%; margin: left 10px;margin: right 10px; align-self: center;">
    ...
    <table style="width: 110%; margin-left:auto;">
        <tr>
...
RA 2018
        ...
        <tr>
            ...
            <td style="text-align: center;">585.0 Min.</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
            ...
            <td style="text-align: center;">1.06 Min.</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"> </td>
        </tr>
        <tr>
            ...
            <td style="text-align: center;">10.0 Min.</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
...
RA 2018
            ...
            <td style="text-align: center;">0.30 Max.</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
...
RA 2019
            ...
            <td style="text-align: center;">0.055 Max.</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
...
Grade : Fe-550
        ...
        <tr>
            ...
            <td style="text-align: center;">0.100 Max.</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
