...
<table style=" width: 110%; margin: left 10px;margin: right 10px; align-self: center;">
    ...
    <table style="width: 110%; margin-left:auto;margin-right:;">
        <tr>
          <th style="padding: 2px; text-align: center;">S.No.</th>
          <th style="padding: 2px; text-align: center;  ">Weight ( kg)</th>
          <th style="padding: 2px 6px; text-align: center; ">Area  (mm2)</th>
          <th style="padding: 2px 9px; text-align: center; ">Load  (KN)
</th>
          <th style="padding: 2px; text-align: center; ">Compressive Strength
            ( N/ mm2)
            </th>
          <th style="padding: 2px 5px; text-align: center;">Test Method</th>
        </tr>
        <tr>
            ...
            <td style="text-align: center;"> </td>
            <td style="text-align: center;"> </td>
            <td style="text-align: center;" rowspan="4">IS : 516-1959, 
                RA 2018
                 </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center;" colspan="5">Average Compressive Strength N/ mm2   =   </td>
        </tr>
