...
<table style=" width: 110%; margin: left 10px;margin: right 10px; align-self: center;">
    ...
    <table style="width: 110%; margin-left:auto;">
        ...
        <tr>
            ...
            <td style="text-align: center;" rowspan="9">IS:15658 -2021, Annex D</td>
            <td style="text-align: center;" rowspan="9">Individual- 27.0 Min. <br><span style="margin-top: 150px;">Average- 34.0 Min.</span></td>
        ...
        <tr>
            ...
            <td style="text-align: left;">Average Compressive Strength</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
