...
<table style=" width: 110%; margin: left 10px;margin: right 10px; align-self: center;">
    ...
    <div>
    <table style="width: 110%;margin-top:-20px;">
        <tr>
...
as per <br>
IS : 383-2016 With Amendment No. 1,2 <br>
 (Zone – II)
        ...
        <tr>
            ...
            <td style="text-align: center;" rowspan="7">IS:2386(P-1)-1963</td>
        ...
        <tr>
            ...
            <td style="text-align: center;">90-100
                </td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
            ...
            <td style="text-align: center;">75-100              
                </td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
            ...
            <td style="text-align: left;">1.18 mm</td>
            <td style="text-align: center;">55-90              
                </td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
            ...
            <td style="text-align: left;">600 micron</td>
            <td style="text-align: center;">35-59              
                </td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
            ...
            <td style="text-align: left;">300 micron</td>
            <td style="text-align: center;">8-30             
                </td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
            ...
            <td style="text-align: left;">150 micron</td>
        ...
        <tr>
            ...
            <td style="text-align: center;">IS:2386 (P-3)- 1963
                                                
                </td>
            <td style="text-align: center;">3.2 Max.</td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: center;">IS:2386 (P-5)- 1963
                                                
                </td>
            <td style="text-align: center;">10.0 Max.                
                </td>
                <td></td>
                <td></td>
        </tr>
        <tr>
            ...
            <td style="text-align: center;">15.0 Max.                
                </td>
                <td></td>
                <td></td>
        </tr>
...
With Amendment No. 1,2
        ...
        <tr>
            ...
            <td style="text-align: center;">IS:2386 (P-1)- 1963
                                                
                </td>
            <td style="text-align: center;">3.0 Max.                
                </td>
                <td></td>
                <td></td>
        </tr>
        <tr>
            ...
            <td style="text-align: center;">IS:2386 (P-2)- 1963
        ...
        <tr>
            ...
            <td style="text-align: left;">Silt Content,%
                            </td>
            <td style="text-align: center;">CPWD Specification
                                                
                </td>
            <td style="text-align: center;">8.0 Max.                
                </td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
        <tr>
            ...
            <td style="text-align: left;">Organic Impurities
                            </td>
            <td style="text-align: center;">IS:2386 (P-2)- 1963
                                                
                </td>
            <td style="text-align: center;">The Colour of Solution is lighter than Std. Solution                
                </td>
            <td style="text-align: center;"></td>
            <td style="text-align: center;"></td>
        </tr>
