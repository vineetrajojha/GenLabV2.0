        ...
        <div class="card">
            ...
            <div class="mb-4 mt-4 ms-3">
                <div class="d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('superadmin.bookingInvoiceStatuses.index', [
                        'search' => request('search'), 
                        'payment_option' => request('payment_option', 'without_bill')
                    ])); ?>"
                    ...
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('superadmin.bookingInvoiceStatuses.index', ['department' => $dept->id, 'search' => request('search'), 'payment_option' => request('payment_option', 'without_bill')])); ?>"
            ...
            <div class="card-body p-0">
                <form action="<?php echo e(route('superadmin.cashLetter.payments.showMultiple')); ?>" method="GET">
                    <?php echo csrf_field(); ?>
                    ...
                    <table class="table table-hover"> <!-- Added table-hover -->
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                        $isPaid = $booking->cashLetterPayments->contains(function($cp) {
                                            return $cp->pivot->payment_status === 'paid';
                                        });
                                    ?>

                            <tr   <?php if($isPaid): ?> class="table-success" <?php endif; ?>>
                                <td>
                                    <label class="checkboxs">
...
<?php echo $__env->make('superadmin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\GenTech\htdocs\GenTech_bug\GenLab\resources\views/superadmin/accounts/cashLetter/index.blade.php ENDPATH**/ ?>