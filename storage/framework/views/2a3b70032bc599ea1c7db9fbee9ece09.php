        ...
        <form action="<?php echo e(route('superadmin.cashPayments.store')); ?>" method="POST">
            ...
            <div class="row"> 
                <div class="col-md-4">
                    ...
                    <input type="number" id="tax_amount" name="tax_amount" class="form-control fw-bold" value="<?php echo e($invoice->gst_amount); ?>" readonly>
                </div>
...
<?php echo $__env->make('superadmin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\GenTech\htdocs\GenTech_bug\GenLab\resources\views/superadmin/cashPayments/create.blade.php ENDPATH**/ ?>