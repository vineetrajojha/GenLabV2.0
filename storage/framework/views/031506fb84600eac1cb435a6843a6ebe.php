...
<div class="content">
    ...
    <form id="invoiceForm" method="post">
        <?php echo csrf_field(); ?>
        <input type="hidden" id="td_booking_ids" name="booking_ids" value='<?php echo json_encode($bookings->pluck("id"), 15, 512) ?>'>
        <div class="page-header d-flex justify-content-between align-items-center">
            ...
            <div class="page-btn">
                <button type="submit" class="btn btn-danger submit-btn" formaction="<?php echo e(route('superadmin.bookingInvoiceStatuses.generateInvoice', $bookings->first()->id)); ?>">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered mb-4">
                    <tr>
                        <th>Client Name</th>
                        <td class="noteditable" id="td_client_name"><?php echo e($bookings->first()->client->name ?? 'N/A'); ?></td>
                        <th>Marketing Person</th>
                        <td class="noteditable" id="td_marketing_person"><?php echo e($bookings->first()->marketingPerson->name ?? '-'); ?></td>
                    </tr>
                    <tr>
                        <th>Invoice No </th>
                        <td contenteditable="true" class="editable" id="td_invoice_no"><?php echo e($invoice_no ?? '00'); ?></td>
                        <th>Reference No</th>
                        <?php
                            $allReferences = $bookings->pluck('reference_no')->filter()->implode(', ');
                        ?>
                        <td contenteditable="true" class="editable" id="td_reference_no"><?php echo e($allReferences  ?? ''); ?></td>
                    </tr>
                    <tr>
                        <th>Invoice Date</th>
                        ...
                        <?php
                            $allLetterDates = $bookings->pluck('job_order_date')
                                ...
                                ->implode(', ');
                        ?>
                        <td class="noteditable" id="td_letter_date"><?php echo e($allLetterDates ?? ''); ?></td>
                    </tr>   
                    <tr>
                        <th>Name of Work</th>
                            ...
                            <?php if($booking->items->isNotEmpty()): ?>
                                <?php $__currentLoopData = $booking->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td contenteditable="true" class="editable rate"><?php echo e($item->amount); ?></td>
                ...
                <div class="d-flex justify-content-end align-items-center gap-3 mb-3">
                 ...
                 <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-success submit-btn" formaction="<?php echo e(route('superadmin.bookingInvoiceStatuses.storeBulk')); ?>">
...
<?php echo $__env->make('superadmin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\GenTech\htdocs\GenTech_bug\GenLab\resources\views/superadmin/accounts/generateInvoice/bulk_create.blade.php ENDPATH**/ ?>