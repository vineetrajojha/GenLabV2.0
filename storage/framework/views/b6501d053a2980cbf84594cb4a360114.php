...
<div class="card mt-4">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($invoice->relatedBooking->client_name ?? 'N/A'); ?></td>
    ...
    <?php if($invoice->invoice_letter_path): ?>
        <a href="<?php echo e(url($invoice->invoice_letter_path)); ?>" class="btn btn-sm btn-outline-primary" target="_blank">Pdf</a>
    <?php else: ?>
...
<?php echo $__env->make('superadmin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GenLab\resources\views/superadmin/accounts/invoiceList/index.blade.php ENDPATH**/ ?>